...
//    private static json_config config = new json_config();
    ...
    private static String v1_idcompra = "0";
    ...
    private static String nombre_ticket = "TICKET compra";

    private void cargar_datos_compra(Connection conn, int idcompra) {
        ...
        String sql = "select ci.idcompra as idcompra,\n"
                ...
                + "TRIM(to_char(ci.total_gral,'999G999G999')) as monto,\n"
                + "(ici.fk_idpro_producto||'-'||ici.descripcion) as producto,\n"
    ...
    private String cargar_datos_para_mensaje_textarea() {
        ...
        mensaje_impresora = mensaje_impresora + "IDCOMPRA:" + v1_idcompra + saltolinea;
    ...
    private static void crear_archivo_texto_impresion() throws PrintException, FileNotFoundException, IOException {
        ...
        printer.printTextWrap(2 + tempfila, 2, jsprint.getSep_inicio(), totalColumna, "IDCOM:" + v1_idcompra);
        printer.printTextWrap(2 + tempfila, 2, jsprint.getSep_fecha(), totalColumna, "FEC:" + v2_fecha);
        printer.printTextWrap(3 + tempfila, 3, jsprint.getSep_inicio(), totalColumna, "USUARIO: " + v3_usuario);
    ...
    public void boton_imprimir_pos_compra(Connection conn, int idcompra) {
        cargar_datos_compra(conn, idcompra);
