...
public class DAO_gasto {
    ...
    private String sql_select = "SELECT g.idgasto as idg,to_char(g.fecha_creado,'yyyy-MM-dd HH24:MI') as fecha,g.descripcion,g.estado,g.monto_gasto "
            + "FROM gasto g ";
