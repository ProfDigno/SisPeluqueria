...
public class DAO_funcionario_recibo {
	...
	private String sql_select = "SELECT idfuncionario_recibo,fecha_creado,creado_por,descripcion,monto_recibo,monto_letra,estado,pago_comision,pago_salario,fk_idfuncionario,fk_idfuncionario_grupo_comision,fk_idusuario FROM funcionario_recibo order by 1 desc;";
	...
	public void actualizar_tabla_funcionario_recibo(Connection conn,JTable tbltabla){
