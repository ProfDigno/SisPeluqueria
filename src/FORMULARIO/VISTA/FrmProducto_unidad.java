 ...
 * @author Digno
 */
public class FrmProducto_unidad extends javax.swing.JInternalFrame {
    ...
    private String nombre_formulario="PRODUCTO UNIDAD";
    String creado_por="DIGNO";
    private void abrir_formulario() {
        this.setTitle(nombre_formulario);
        evetbl.centrar_formulario_internalframa(this);        
        reestableser();
        DAOpu.actualizar_tabla_producto_unidad(conn, tbltabla);
        color_formulario();
    }
    ...
    private void boton_guardar() {
        if (validar_guardar()) {
            ...
            ENTpu.setC5nombre(txtnombre.getText());
            ENTpu.setC4activo(jCactivar.isSelected());
            BOpu.insertar_producto_unidad(ENTpu, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ...
            ENTpu.setC5nombre(txtnombre.getText());
            ENTpu.setC4activo(jCactivar.isSelected());
            BOpu.update_producto_unidad(ENTpu, tbltabla);
        }
    }
    ...
    private void seleccionar_tabla() {
        ...
        jCactivar.setSelected(ENTpu.getC4activo());
        txtnombre.setText(ENTpu.getC5nombre());
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOpu.ancho_tabla_producto_unidad(tbltabla);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
        DAOpu.buscar_tabla_producto_unidad(conn, tbltabla, txtbuscar);
