 ...
 * @author Digno
 */
public class FrmServicio_categoria extends javax.swing.JInternalFrame {
    ...
    private BO_servicio_categoria BOsc = new BO_servicio_categoria();
    private EvenJTextField evejtf = new EvenJTextField();
    Connection conn = ConnPostgres.getConnPosgres();
    cla_color_palete clacolor = new cla_color_palete();
    private String nombre_formulario = "SERVICIO CATEGORIA";
    ...
    private void abrir_formulario() {
        ...
        reestableser();
        DAOsc.actualizar_tabla_servicio_categoria(conn, tbltabla);
        color_formulario();
    }
    ...
    private boolean validar_guardar() {
        ...
        if (evejtf.getBoo_JTextField_vacio(txtruta_icono, "DEBE CARGAR UN ICONO")) {
            return false;
        }
        return true;
    }
    ...
    private void cargar_dato() {
        ENTsc.setC3creado_por(creado_por);
        ENTsc.setC4orden(Integer.parseInt(txtorden.getText()));
        ENTsc.setC5activo(jCactivar.isSelected());
        ENTsc.setC6nombre(txtnombre.getText());
        ENTsc.setC7ruta_icono(txtruta_icono.getText());
    }

    private void boton_guardar() {
        if (validar_guardar()) {
            cargar_dato();
            BOsc.insertar_servicio_categoria(ENTsc, tbltabla);
            reestableser();
        }
    }
    ...
    private void boton_editar() {
        if (validar_guardar()) {
            ENTsc.setC1idservicio_categoria(Integer.parseInt(txtid.getText()));
            cargar_dato();
            BOsc.update_servicio_categoria(ENTsc, tbltabla);
        }
    }

    private void seleccionar_tabla() {
        int id = eveJtab.getInt_select_id(tbltabla);
        DAOsc.cargar_servicio_categoria(conn, ENTsc, id);
        txtid.setText(String.valueOf(ENTsc.getC1idservicio_categoria()));
        jCactivar.setSelected(ENTsc.getC5activo());
        txtorden.setText(String.valueOf(ENTsc.getC4orden()));
        txtnombre.setText(ENTsc.getC6nombre());
        txtruta_icono.setText(ENTsc.getC7ruta_icono());
    ...
    private void reestableser() {
        ...
        txtorden.setText(eveconn.getInt_ultimo_ORDEN_mas_uno(conn,"servicio_categoria","orden"));
        txtruta_icono.setText(null);
    ...
    private void initComponents() {
        ...
        txtruta_icono = new javax.swing.JTextField();
        ...
        txtruta_icono.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtruta_icono.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtruta_iconoKeyPressed(evt);
            }
        });
        ...
        panel_insertarLayout.setVerticalGroup(
            ...
            .addGroup(panel_insertarLayout.createSequentialGroup()
                ...
                .addGroup(panel_insertarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtruta_icono, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jCactivar)
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // TODO add your handling code here:
        DAOsc.ancho_tabla_servicio_categoria(tbltabla);
...
//        evejtf.saltar_campo_enter(evt, txtnombre, txtprecio_venta);
    ...
    private void txtbuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtbuscarKeyReleased
        // TODO add your handling code here:
        DAOsc.buscar_tabla_servicio_categoria(conn, tbltabla, txtbuscar);
    ...
    private void txtruta_iconoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtruta_iconoKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtruta_iconoKeyPressed
    ...
    private javax.swing.JTextField txtruta_icono;
